	...
	<div id="bookly_pmt_<?php echo $id; ?>" class="collapse show">
		<div class="card-body">
			...
			<div class="bookly-knit-pay">
				...
				<?php Inputs::renderText( 'bookly_' . $id . '_timeout', __( 'Time interval of payment gateway (in Seconds)', 'knit-pay' ), __( 'This setting determines the time limit after which the payment made via the payment gateway is considered to be incomplete. This functionality requires a scheduled cron job.', 'knit-pay' ) ); ?>
			</div>
		</div>
	</div>
</div>
