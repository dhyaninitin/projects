...
class Integration extends AbstractGatewayIntegration {
	...
	public function get_settings_fields() {
		...
		$fields[] = [
			...
			'title'    => __( 'Payment Page Title', 'knit-pay' ),
			'type'     => 'text',
		...
		$fields[] = [
			...
			'title'    => __( 'Payment Page Description', 'knit-pay' ),
			'type'     => 'text',
			'classes'  => [ 'regular-text', 'code' ],
		];
		...
		$fields[] = [
			...
			'title'    => __( 'Account Details Page', 'pronamic_ideal' ),
			'type'     => 'select',
			'tooltip'  => __( 'Create a page with other details you want to display on the payment page. Example bank account details, Office Address, etc.', 'knit-pay' ),
			'options'  => $pages,
		];
