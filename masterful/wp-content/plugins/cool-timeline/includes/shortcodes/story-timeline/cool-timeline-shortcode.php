			...
			while ($ctl_loop->have_posts()) : $ctl_loop->the_post();
				...
				if($layout =="horizontal"){
					...
					if( $display_readmore=="yes"){
						...
						$horizontal_html.='<a  href="#askaquestion">';

					}
					$count=$i+1;

					//$horizontal_html.='<div class="ctl-story-year"><span class="rm_year">'.$i.' '.esc_html($story_main_date).'</span></div>';
					$horizontal_html.='<div class="ctl-story-year"><span class="rm_year">STEP '.$count.'</span></div>';
