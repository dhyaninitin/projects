...
final class Main
{
    ...
    {
        $links[] = '<a href="' . admin_url( 'admin.php?page=integrate-google-drive-settings' ) . '">' . __( 'Settings', 'integrate-google-drive' ) . '</a>';
        $links[] = '<a href="' . admin_url( 'admin.php?page=integrate-google-drive-getting-started' ) . '">' . __( 'Help', 'integrate-google-drive' ) . '</a>';
        return $links;
    }
    ...
    {
        load_plugin_textdomain( 'integrate-google-drive', false, IGD_PATH . '/languages/' );
    }
