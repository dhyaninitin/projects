    ...
    children: [
      ...
      },
      {
        ...
        children: [
          {
            path: '',
            loadChildren: () => import('../app/pages/work-diary/work-diary.module').then(m => m.WorkDiaryModule),
            data: {
              toolbarShadowEnabled: true
            }
          }
      ...
      },
      {
        ...
        children: [
          {
            path: '',
            loadChildren: () => import('../app/pages/user-permission/user-permission.module').then(m => m.UserPermissionModule),
            data: {
              toolbarShadowEnabled: true
            }
          }
      ...
      },
      {
        ...
        children: [
          {
            path: '',
            loadChildren: () => import('../app/pages/tracker-error-logs/tracker-error-logs.module').then(m => m.TrackerErrorLogsModule),
            data: {
              toolbarShadowEnabled: true
            }
          }
