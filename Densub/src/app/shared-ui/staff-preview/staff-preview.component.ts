...
import { StaffProfile } from '../modal/staff-profile.modal';
...
import { SkillType } from '../../views/dashboard-pages/admin/skills/skill-type/skill-type.modal';
...
import { WorkDiaryService } from '../service/workDiary.service';
...
import { UserCalendarService } from '../service/userCalendar.service';
...
@Component({
  ...
  styleUrls: ['./staff-preview.component.scss'],
  animations: [
...
export class StaffPreviewComponent implements OnInit {
  ...
  @Input() staffPreviewId:any;
  inviteModel: boolean = false;
  constructor(
  ...
  ngOnInit() {
    ...
    if(this.staffPreviewId){
      this.userId = this.staffPreviewId;
      this.getUsersData();
